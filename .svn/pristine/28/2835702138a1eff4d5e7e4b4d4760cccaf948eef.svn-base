...
void ossimPlanetTerrain::UpdateTileCallback::update(ossimPlanetTerrainTile* tile, osg::NodeVisitor* nv)
{
}
...
void ossimPlanetTerrain::CullTileCallback::cull(ossimPlanetTerrainTile* tile, osg::NodeVisitor* nv)
{
}
