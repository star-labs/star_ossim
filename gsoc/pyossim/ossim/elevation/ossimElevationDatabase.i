...
%rename(const_ossimElevationDatabase_getGeoid) ossimElevationDatabase::getGeoid() const;
%rename(ossimElevationDatabase_open) ossimElevationDatabase::open(ossimString const &);
