...
void ossimGui::HistogramRemapperEditor::populateClipPoints()
{
   ...
   if(m_histogramRemapper.valid())
   {
      ...
      m_lowClipPercentLineEdit->setText(QString().setNum(value, 'g', 3));
