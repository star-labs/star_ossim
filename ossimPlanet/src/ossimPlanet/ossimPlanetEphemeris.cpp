...
void ossimPlanetEphemeris::EphemerisData::updatePositions(osg::NodeVisitor& nv)
{
   ...
   gpstk::DayTime now(gmt.getYear(),
                      ...
                      gpstk::DayTime::UTC);
   gpstk::ECEF sunEcef;
   sunEcef = gpstk::ECEF(theSunPosition.getPosition(now));
   gpstk::Position eyeLocation(theEyeLlh[0],
                               theEyeLlh[1],
                               theEyeLlh[2],
                               gpstk::Position::Geodetic,
                               &theGeoidModel);
   gpstk::Geodetic sunLlh = sunEcef.asGeodetic(&theGeoidModel);
   ...
   gpstk::Position sunPosition(sunLlh.getLatitude(),
                               ...
                               gpstk::Position::Geodetic,
                               &theGeoidModel);
   theSunAzimuth   = eyeLocation.azimuthGeodetic(sunPosition);
   theSunElevation = eyeLocation.elevationGeodetic(sunPosition);
   
   theSunLlh = osg::Vec3d(sunLlh.getLatitude(),
                          sunLlh.getLongitude(),
                          sunLlh.getAltitude());
   gpstk::ECEF moonEcef;
   moonEcef = gpstk::ECEF(theMoonPosition.getPosition(now));
   gpstk::Geodetic moonLlh = moonEcef.asGeodetic(&theGeoidModel);
   
   theMoonLlh = osg::Vec3d(moonLlh.getLatitude(),
